...
- [文件清单](#文件清单)
- [一、`service_snlua.c` — Lua 服务宿主 ★](#一service_snluac--lua-服务宿主)
  - [核心数据结构](#核心数据结构)
  - [生命周期函数](#生命周期函数)
  - [Lua 内存管理](#lua-内存管理)
  - [snlua 消息回调](#snlua-消息回调)
  - [Lua Code Cache](#lua-code-cache)
- [二、`service_gate.c` — TCP 网关服务](#二service_gatec--tcp-网关服务)
  - [功能概述](#功能概述)
  - [核心数据结构](#核心数据结构-1)
  - [生命周期](#生命周期)
  - [连接管理](#连接管理)
  - [控制命令](#控制命令)
- [三、`service_harbor.c` — 集群通信服务](#三service_harborc--集群通信服务)
  - [功能概述](#功能概述-1)
  - [协议](#协议)
  - [核心数据结构](#核心数据结构-2)
  - [状态机](#状态机)
  - [消息类型](#消息类型)
- [四、`service_logger.c` — 日志服务](#四service_loggerc--日志服务)
  - [功能](#功能)
  - [核心结构](#核心结构)
  - [消息处理](#消息处理)
- [五、`databuffer.h` — 数据缓冲区](#五databufferh--数据缓冲区)
- [六、`hashid.h` — ID 哈希表](#六hashidh--id-哈希表)
